...
async def load_data():
    ...
    # Leer el archivo csv desde la ruta relativa y crear el dataframe global
     # Leer el archivo csv desde la ruta relativa y crear el dataframe global
    df_fc1 = pd.read_csv('Datasets/funcion_1.csv')
    df_final_f1 = pd.DataFrame(df_fc1)
    df_fc2 = pd.read_csv('Datasets/funcion_2.csv')
    df_final_f2 = pd.DataFrame(df_fc2)
    df_fc3 = pd.read_csv('Datasets/funcion_3_4.csv')
    df_final_f3_4 = pd.DataFrame(df_fc3)
    df_fc5 = pd.read_csv('Datasets/funcion_5.csv')
    df_final_f5 = pd.DataFrame(df_fc5)
    df_fc6 = pd.read_csv('Datasets/Machine_learning.csv')
